...
main (int   argc,
      char *argv[])
{
  TestObject *obj1 = g_object_new (TEST_TYPE_OBJECT,
                                  "foo", 47,
                                  "bar", FALSE,
                                  "baz", "Hello, World!",
                                  "meh", 0.5,
                                  NULL);
  TestObject *obj2 = g_object_new (TEST_TYPE_OBJECT,
                                  "foo", 12123,
                                  "bar", FALSE,
                                  "baz", "Fuck, World!",
                                  "meh", 0.5,
  ...
  node = json_gobject_serialize(G_OBJECT(obj1));
  json_array_add_element(array, node);

  node = json_gobject_serialize(G_OBJECT(obj2));
  json_array_add_element(array, node);
