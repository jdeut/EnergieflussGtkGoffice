...
dialog_property_editor (GObject *object, gchar *label, GtkWindow *window)
{
    ...
    if(MY_IS_FLOW_ARROW(object)) {
        ...
        g_object_set(hbox, "margin-top", 10, "margin-bottom", 10, "margin-left", 10, "margin-right", 10, NULL);
        ...
        g_object_bind_property (object, "energy-quantity", button, "value", G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE);
        ...
        g_object_bind_property (object, "label-text", entry, "text", G_BINDING_BIDIRECTIONAL | G_BINDING_SYNC_CREATE);
